...
function Mood1() {
  return (
      <><TitleBar /><div className="flex relative justify-center items-center bg-white">
      <div className="flex justify-center relative items-center">
        <div className="h-[22px] left-[20px] top-[150px] absolute justify-center items-center inline-flex">
          <div className="w-[200px] h-[22px] text-center text-neutral-800 text-xl font-semibold mb-6">
            Chat with celebrities
          </div>
        </div>
        <div className="h-[77px]  left-[7px] top-[180px] absolute justify-center items-center inline-flex">
        ...
        <img
          className=" h-[76px] left-[268px] top-[180px] absolute border"
          src={DarthVader} />
        <div className="left-[99px] top-[300px] absolute justify-start items-start inline-flex">
          <Button
            variant="contained"
      ...
      <div className="w-full flex justify-center relative items-center">
        <div className="w-6 h-6 pl-1 pr-[3.50px] pt-[4.95px] pb-[5.50px] left-[50px] top-[520px] absolute justify-center items-center inline-flex">
          ...
          <img className="w-[80px] h-[76px] absolute border" src={Face} />
        </div>
