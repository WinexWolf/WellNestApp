  ...
  return (
    <div className={classes.background}>
      ...
      <div className={classes.flexContainer}>
        <div className={classes.firstLine}>Upcoming Therapy Session</div>
        <div style={{ width: "100%" }}>
          <img
        ...
        <div className={classes.buttonContainer} style={{ paddingTop: "20px" }}>
          ...
          <Button
            ...
            onClick={() => {
              window.open(
                "https://cmu.zoom.us/j/99143300269?pwd=bklTWTQ3NGJNRVhubWVtMlhMUGxsQT09",
                "_blank",
                "noreferrer"
              );
            }}
