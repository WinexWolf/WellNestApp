...
const TherapyConfirmCard = ({ handleSwipe, active, setBalance }) => {
  ...
  const setLocal = (balanceType, balance) =>
    localStorage.setItem(balanceType, balance.toString());
  ...
  return (
    <div className={classes.background}>
        ...
        <ReusableModal
          ...
          modalText={
            <div style={{ textAlign: "center" }}>
              <div className={classes.smallContent}>Your appointment with</div>
              <div
              ...
              <div className={classes.smallContent}>has been confirmed for</div>
              <div
                className={classes.smallContent}
                style={{
                  paddingTop: "5px",
              ...
              <div className={classes.smallContent}>at</div>
              <div
                className={classes.smallContent}
                style={{
                  paddingTop: "5px",
      ...
      <div className={classes.flexContainer}>
        <div className={classes.firstLine}>Therapist Matched!</div>
        <div style={{ width: "100%" }}>
          <img
        ...
        <div className={classes.smallTitle} style={{ paddingTop: "20px" }}>
          Name:
        </div>
        <div className={classes.smallContent} style={{ paddingTop: "5px" }}>
          {currentTherapist.Name}
        </div>
        <div className={classes.smallTitle} style={{ paddingTop: "5px" }}>
          Qualifications:
        </div>
        <div className={classes.smallContent} style={{ paddingTop: "5px" }}>
        ...
        <div className={classes.buttonContainer} style={{ paddingTop: "20px" }}>
          <Button
            variant="contained"
            style={{
            ...
            onClick={() => {
              var matchedTherapist = getLocal("next_therapist");
              var nextTherapist =
                (matchedTherapist + 1) % TherapistInfoModels.length;
              setLocal("next_therapist", nextTherapist);
              handleSwipe(2);
            }}
          >
